...
PROGMEM const char text1_6[] = "Marauder Plus ";
...
PROGMEM const char text1_52[] = "Con Cac Beacon";
...
PROGMEM const char text4_20[] = "Firmware: Marauder Plus";      //From 20 to 35 add spaces so : is in line like it is now
